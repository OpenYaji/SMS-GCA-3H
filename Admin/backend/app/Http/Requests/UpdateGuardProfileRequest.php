...
class UpdateGuardProfileRequest extends FormRequest
{
    /**
    ...
    {
        $guardProfile = $this->route('guard_profile');// passed guard based on the param name
        $userId = $guardProfile?->profile?->user?->UserID;
