      ...
      <nav className="flex space-x-4 w-fit">
        {tabs.map((tab) => (
          <button
            ...
            className={`px-8 py-3 rounded-lg font-kumbh text-base font-medium transform transition-all duration-300 shadow-inner shadow-gray-300 dark:shadow-gray-700 ${
              activeTab === tab.id
                ? "bg-yellow-400 dark:bg-yellow-500 text-gray-900 shadow-[0_4px_10px_rgba(0,0,0,0.25)] scale-[1.02]"
