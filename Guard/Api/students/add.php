...
$result = $conn->query("INSERT INTO students (student_id, name, qrcode, section, grade_level, adviser_name) VALUES
('$student_id', '$name', '$qrcode', '$section', '$grade_level', '$adviser_name')");
