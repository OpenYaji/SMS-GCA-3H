<?php
// updateStage.php - HYBRID SOLUTION: Instant Response + Background Email (Using FPM)

// Set CORS headers early to ensure they are sent during preflight (OPTIONS)
...
try {
    ...
    $stmt = $conn->prepare("
        SELECT a.ApplicationID, a.TrackingNumber, a.StudentFirstName, a.StudentLastName, a.GuardianEmail, 
               a.EnrolleeType, a.EmailAddress as StudentEmail, a.GuardianFirstName, a.GuardianLastName, 
