...
class Dashboard {
    ...
    /**
     * Retrieves the SchoolYearID where IsActive is TRUE (or 1) from the schoolyear table.
     * This ID is used to filter all dashboard counts.
    ...
    /**
     * Checks if there is no active school year. If true, all dashboard counts
     * will automatically return 0, achieving the "reset" functionality.
