...
          {/* Credentials Card (Only Student Number) */}
...
          {/* Removed: Subjects Assigned Card */}
          
         {/* Warning - Updated Message to revert to default password prompt */}
...
                <strong>Important:</strong> The student must change the default password upon first login.
              </p>
            </div>
          </div>
