...
const LIVE_API = "http://localhost/SMS-GCA-3H/Registrar/backend/api/dashboard/tasks.php";
...
const Tasks = () => {
  ...
  useEffect(() => {
    ...
    evtSource.onmessage = (event) => {
      ...
      setCount(data.pending_tasks ?? 0);
      console.log("Live pending tasks:", data.pending_tasks);
    };
