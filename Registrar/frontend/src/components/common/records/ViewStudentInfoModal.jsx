            ...
            <div className="col-span-1">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">Jhego</p>
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Age</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">14</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">Waw</p>
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Sex</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">M</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">Dacayo</p>
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Birthday</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">03/04/01</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">Laguna</p>
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Religion</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Catholic</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">167cm</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">Filipino</p>
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Height</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">49kg</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-1">
              <div className="space-y-4">
                ...
                <div className="pt-4">
                  ...
                  <p className="text-sm text-gray-400 dark:text-gray-500">Lorem</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">+63 XXX XXX XXXX</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">sample@gmail.com</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 dark:text-gray-500">Impsum</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 dark:text-gray-500">Lorem Ipsum</p>
                </div>
