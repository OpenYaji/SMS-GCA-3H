...
const Login = () => {
  ...
  // Redirect immediately when Student is selected
  ...
  // Smaller student redirect notice
  const StudentRedirectNotice = () => (
  ...
  const LoginForm = () => (
    <form className="space-y-3" onSubmit={handleSubmit}>
      <div className="relative">
        <input 
          type="text" 
          placeholder={`${Roles[selectedRole].label} ID / Email`}
          value={username}
          autoFocus
          onChange={(e) => setUsername(e.target.value)}
          className="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-full focus:ring-2 focus:ring-amber-500 transition duration-300 placeholder-gray-500 dark:placeholder-gray-400 text-gray-800 dark:text-gray-100 bg-white dark:bg-gray-700 shadow-sm text-sm disabled:opacity-50"
        />
