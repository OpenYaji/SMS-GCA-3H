  ...
  const fetchUserPreferences = async () => {
    try {
      const response = await axios.get(
        'http://localhost/sms-gca-3H/SMS-GCA-3H/Teacher/backend/api/teachers/get-appearance-settings.php',
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.post(
        'http://localhost/sms-gca-3H/SMS-GCA-3H/Teacher/backend/api/teachers/update-appearance-settings.php',
        {
          theme: selectedTheme,
