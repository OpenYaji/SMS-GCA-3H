  ...
  const fetchAttendance = async () => {
    try {
      ...
      const response = await axios.get(
        `http://localhost/sms-gca-3H/SMS-GCA-3H/Teacher/backend/api/attendance/get-section-attendance.php?sectionId=${classData.id}&date=${selectedDate}`,
  ...
  const handleStatusChange = async (studentId, newStatus) => {
    try {
      ...
      const response = await axios.post(
        'http://localhost/sms-gca-3H/SMS-GCA-3H/Teacher/backend/api/attendance/update-attendance.php',
        {
          studentId: studentId,
          status: newStatus,
          date: selectedDate
