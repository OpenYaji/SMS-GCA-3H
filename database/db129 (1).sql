...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2025 at 07:55 PM
...
(29, NULL, 7, 6, 'New', 'For Review', NULL, NULL, NULL, '2025-12-09 02:46:29', NULL, '', 'aa', 'aaa', 'aaa', '2020-11-21', 'Male', '121212121212212', '01233122311', '31231313@gmailc.om', 'asdsada', 'dasds', 'adad', '32131313131', 'adsadasda@gmail.com', 'GCA-2025-68475', 1, NULL);
...
(24, 50, 1, 20000.00, '2025-12-09 01:43:12', 'DOWNPAY-24-1765215792', NULL, 'Verified', 1, '2025-12-09 01:43:12', NULL, NULL, NULL),
(25, 51, 1, 20000.00, '2025-12-09 01:44:55', 'DOWNPAY-25-1765215895', NULL, 'Verified', 1, '2025-12-09 01:44:55', NULL, NULL, NULL),
(26, 52, 1, 9600.00, '2025-12-09 02:03:13', 'DOWNPAY-26-1765216993', NULL, 'Verified', 1, '2025-12-09 02:03:13', NULL, NULL, NULL),
(27, 53, 1, 8900.00, '2025-12-09 02:09:47', 'DOWNPAY-27-1765217387', NULL, 'Verified', 1, '2025-12-09 02:09:47', NULL, NULL, NULL),
(28, 54, 1, 9600.00, '2025-12-09 02:32:05', 'DOWNPAY-28-1765218725', NULL, 'Verified', 1, '2025-12-09 02:32:05', NULL, NULL, NULL);
...
--
ALTER TABLE `attendancesummary`
  MODIFY `AttendanceSummaryID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `emergencycontact`
  MODIFY `EmergencyContactID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `enrollment`
--
ALTER TABLE `enrollment`
  MODIFY `EnrollmentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `grade`
  MODIFY `GradeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1129;
...
--
ALTER TABLE `guardian`
  MODIFY `GuardianID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `medicalinfo`
  MODIFY `MedicalInfoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `passwordpolicy`
  MODIFY `PolicyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `studentguardian`
  MODIFY `StudentGuardianID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `studentprofile`
--
ALTER TABLE `studentprofile`
  MODIFY `StudentProfileID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `transaction`
  MODIFY `TransactionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
